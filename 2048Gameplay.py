...
largefont=game.font.SysFont(None,150)
...
def Win():
    ...
    Over= True
    while Over :
        Mess_To_Screen("YOU WIN !",(255,255,0),300,100,60,60,size='Large')
        Button_For_Text("Play Again",150,230,60,60,90,240,180,40,(79,79,255),Color.Inactive_Color.value,Color.Active_Color.value,"Medium","Play Again")
        Button_For_Text("Quit",460,230,60,60,400,240,180,40,(79,79,255),Color.Inactive_Color.value,Color.Active_Color.value,"Medium","Quit")    
        for event in game.event.get():
            if event.type==game.QUIT:
                game.quit()
                quit()
