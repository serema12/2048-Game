...
def Menu():
    ...
    while Intro:
        ...
        Button_For_Text("Quit",430,240,60,60,370,250,170,40,Color.Board.value,Color.Inactive_Color.value,Color.Active_Color.value,'Medium','Quit',None)
...
def Win(score):
    ...
    while Over :
        ...
        Button_For_Text("Play Again",170,230,60,60,110,240,180,40,Color.Board.value,Color.Inactive_Color.value,Color.Active_Color.value,"Medium","Play Again",None)
        Button_For_Text("Quit",420,230,60,60,360,240,180,40,Color.Board.value,Color.Inactive_Color.value,Color.Active_Color.value,"Medium","Quit",None)    
        for event in game.event.get():
            if event.type==game.QUIT:
                game.quit()
                quit()
